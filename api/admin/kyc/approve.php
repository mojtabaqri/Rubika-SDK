<?php
/**
 * API Endpoint: تایید درخواست احراز هویت (برای ادمین)
 * شیوه: POST
 * 
 * Headers:
...
try {
    ...
    // تایید KYC
    $result = KYCService::approveKYC($verificationId, $adminId, $notes);
    
    if (!$result) {
        APIMiddleware::errorResponse('خطا در تایید درخواست.', 500);
    } else {
        APIMiddleware::jsonResponse(true, [], 'درخواست احراز هویت تایید شد.');
    }
